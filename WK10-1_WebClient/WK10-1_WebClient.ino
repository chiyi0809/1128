...
const char* ssid = "Infinity";  // insert your SSID
const char* password = "0987654322b";  // insert your password
  char jsonRead[600]; //讀取response後儲存JSON資料的變數，必須是全域變數
//const char* host = "api.openweathermap.org";
//const char* resource = "/data/2.5/weather?id=1668341&appid=5a132d4fd3137965ef18b38440e7a2ff";
//char jsonRead[600]; //讀取response後儲存JSON資料的變數，必須是全域變數
...
void ClientRequest(String value1, String value2, String value3) {
  ...
  const char* event = "NEW";  //IFTTT事件名稱
  const char* apiKey = "by9VrPjSKlJmCaCYib8VMK4LE5-KmOpvIBSaby0J3Fo";  //IFTTT Applet key
...
char* ClientRequesta() {
  const char* host = "api.openweathermap.org";
  const char* resource = "/data/2.5/weather?id=1668341&appid=94881739e8170b5fb6464b2c3b86ca8c";

  WiFiClient client;  //建立Client物件
  const int httpPort = 80;  //預設通訊阜80
  String JsonString = "";  //此範例不會用到
//  String weather="weather.length()" ;  //此範例不會用到
//  String weatherfix;
//  int i=0;
// 
  //Client連結Server
